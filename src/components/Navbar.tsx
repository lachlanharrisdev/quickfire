  ...
  return (
    <nav className="relative flex items-end h-20 safe-bottom">
      ...
      <a
        href="/"
        className={cn(
          "relative z-20 flex flex-col items-center justify-center gap-0.5 -mt-3 mx-1 w-20 h-[88px] sm:w-24 sm:h-[92px] rounded-sm transition-colors select-none touch-target-lg",
          "bg-card border-2",
          active === "home"
            ? "border-primary text-primary shadow-[0_0_16px_hsl(var(--primary)/0.3)]"
