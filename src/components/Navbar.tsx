...
export function Navbar({ active = "home" }: NavbarProps) {
    return (
        <nav className="relative flex items-end h-20 safe-bottom">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-20 bg-card border-t-[2px] border-primary/50" />
            ...
            >
                ...
                <span className="font-tactical text-md uppercase tracking-wider">
                    Calculators
                </span>
            </a>
            ...
            <a
                ...
                className={cn(
                    ...
                    active === "home"
                        ...
                        : "border-primary/50 text-muted-foreground hover:text-foreground hover:border-primary/50",
                )}
                draggable={false}
            >
                <Home className="w-8 h-8 sm:w-9 sm:h-9" />
                <span className="font-tactical-bold text-xl uppercase tracking-wider">
                    Home
                </span>
            </a>
